...
cardProductRouter.get(
  "/not",
  cardProductController.getAllNotDeleteCardProducts
);
cardProductRouter.get(
  "/in-use",
  cardProductController.getAllAvailableCardProducts
);
cardProductRouter.get(
  "/in-use/:id",
  cardProductController.getAvailableCardProduct
);
cardProductRouter.post(
  "/",
  userController.protect,
  cardProductController.createCardProduct
);
cardProductRouter.patch(
  "/edit/:id",
  userController.protect,
  cardProductController.editCardProduct
);
cardProductRouter.patch(
  "/delete/:id",
  userController.protect,
  cardProductController.editStatusCardProduct
);
